...
const Header = () => {
  return (
    <div className='h-32 flex justify-between items-center pl-7 lg:pl-[102px] overflow-hidden'>
      <div className='logo text-[26px] font-black'>LOGO</div>
      <div className='menu'>
        <img src='/icons/menu.svg' alt='menu' className='w-40 relative -right-10 -top-4 animate-spin-slow' />
